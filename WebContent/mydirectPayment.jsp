<body oncontextmenu="return false;" onselectstart="return false;" ondragout="return false;"><%@ page language="java" contentType="text/html; charset=ISO-8859-1"
...
<html>
<head>
    <title>Billing - DoDirectPayment API</title>
    <!--  <link href="sdk.css" rel="stylesheet" type="text/css" />-->
</head>
<body>
    <form method="POST" action="DoDirectPaymentReceipt.jsp" name="frmDCC">
		<br>
        ...
        <table class="api">
            ...
            <tr>
                <td class="field">
                    First Name:</td>
                <td>
                    ${sessionScope.login.userName }</td>
            </tr>
            ...
            <tr>
                <td class="field">
                    Amount:</td>
                <td>
                    <input type="text" size="4" maxlength="7" name="amount" value=${requestScope.amt} /> USD
                 </td>
